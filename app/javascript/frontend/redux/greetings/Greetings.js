...
const GET_GREETINGS = 'HELLO-WORLD-RAILS-REACT/app/javascript/frontend/redux/greetings/getGreetings';

const initialState = [];

const getGreetingsApi = 'http://localhost:3000/api/greetings/random';
